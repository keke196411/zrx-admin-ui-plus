...
<ClientOnly>
<div class="w-600 box h-full p-x-12 p-y-16">
    <div class="top">
    ...
    <div class="left">
        ...
        <el-tooltip class="item" content="Left Bottom 提示文字" placement="left-end">
...
| 参数                          | 说明               | 类型   | 可选值 | 默认值 |
| ----------------------------- | ------------------ | ------ | ------ | ------ |
| `--zrx-tooltip-font-size`   | 提示字体大小 | string | -- | 14px  |
| `--zrx-tooltip-padding`   | 提示padding | string | -- | 5px 8px  |
